...
[Script]
Geocaching cache = type=http-response,pattern=^https:\/\/api\.groundspeak\.com\/mobile\/v\d\/geocaches\/GC[A-Z0-9]{5}(?:\/(geocachelogs|userwaypoints|additionalwaypoints))?(?:\?.*)?$,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/axtyet/Luminous/main/Fokit/scripts/geocaching_helper.js
Geocaching map = type=http-response,pattern=^https:\/\/api\.groundspeak\.com\/mobile\/v\d\/map\/search\?adventuresTake,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/axtyet/Luminous/main/Fokit/scripts/geocaching_helper.js
Geocaching unlock = type=http-response,pattern=^https:\/\/api\.groundspeak\.com\/mobile\/v\d\/profileview,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/axtyet/Luminous/main/Fokit/scripts/geocaching_helper.js
Geocaching adventures = type=http-response,pattern=^https:\/\/api\.groundspeak\.com\/adventuresmobile\/v\d\/public\/adventures\/[a-zA-Z0-9-]+,requires-body=1,max-size=0,script-path=https://raw.githubusercontent.com/axtyet/Luminous/main/Fokit/scripts/geocaching_helper.js
...
[Script]
http-response ^https:\/\/api\.groundspeak\.com\/mobile\/v\d\/geocaches\/GC[A-Z0-9]{5}(?:\/(geocachelogs|userwaypoints|additionalwaypoints))?(?:\?.*)?$ tag=Geocaching cache, script-path=https://raw.githubusercontent.com/axtyet/Luminous/main/Fokit/scripts/geocaching_helper.js,requires-body=1
http-response ^https:\/\/api\.groundspeak\.com\/mobile\/v\d\/map\/search\?adventuresTake tag=Geocaching map, script-path=https://raw.githubusercontent.com/axtyet/Luminous/main/Fokit/scripts/geocaching_helper.js,requires-body=1
http-response ^https:\/\/api\.groundspeak\.com\/mobile\/v\d\/profileview tag=Geocaching unlock, script-path=https://raw.githubusercontent.com/axtyet/Luminous/main/Fokit/scripts/geocaching_helper.js,requires-body=1
http-response ^https:\/\/api\.groundspeak\.com\/adventuresmobile\/v\d\/public\/adventures\/[a-zA-Z0-9-]+ tag=Geocaching adventures, script-path=https://raw.githubusercontent.com/axtyet/Luminous/main/Fokit/scripts/geocaching_helper.js,requires-body=1
...
[rewrite_local]
^https:\/\/api\.groundspeak\.com\/mobile\/v\d\/geocaches\/GC[A-Z0-9]{5}(?:\/(geocachelogs|userwaypoints|additionalwaypoints))?(?:\?.*)?$ url script-response-body https://raw.githubusercontent.com/axtyet/Luminous/main/Fokit/scripts/geocaching_helper.js
^https:\/\/api\.groundspeak\.com\/mobile\/v\d\/map\/search\?adventuresTake url script-response-body https://raw.githubusercontent.com/axtyet/Luminous/main/Fokit/scripts/geocaching_helper.js
^https:\/\/api\.groundspeak\.com\/mobile\/v\d\/profileview url script-response-body https://raw.githubusercontent.com/axtyet/Luminous/main/Fokit/scripts/geocaching_helper.js
^https:\/\/api\.groundspeak\.com\/mobile\/v\d\/map\/search\?adventuresTake url script-response-body https://raw.githubusercontent.com/axtyet/Luminous/main/Fokit/scripts/geocaching_helper.js
^https:\/\/api\.groundspeak\.com\/adventuresmobile\/v\d\/public\/adventures\/[a-zA-Z0-9-]+ url script-response-body https://raw.githubusercontent.com/axtyet/Luminous/main/Fokit/scripts/geocaching_helper.js
...
script-providers:
  Geocaching helper:
    url: https://raw.githubusercontent.com/axtyet/Luminous/main/Fokit/scripts/geocaching_helper.js
    interval: 86400
